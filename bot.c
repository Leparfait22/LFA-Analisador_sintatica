...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    PROCURAR = 258,                /* PROCURAR  */
    VOOS = 259,                    /* VOOS  */
    RESERVAR = 260,                /* RESERVAR  */
    NUMERO = 261,                  /* NUMERO  */
    CANCELAR = 262,                /* CANCELAR  */
    RESERVA = 263,                 /* RESERVA  */
    VERIFICAR = 264,               /* VERIFICAR  */
    AJUDA = 265,                   /* AJUDA  */
    LISTAR = 266,                  /* LISTAR  */
    RESERVAS = 267,                /* RESERVAS  */
    DETALHES = 268,                /* DETALHES  */
    SAIR = 269,                    /* SAIR  */
    NUM = 270,                     /* NUM  */
    ID = 271                       /* ID  */
  };
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PROCURAR = 3,                   /* PROCURAR  */
  YYSYMBOL_VOOS = 4,                       /* VOOS  */
  YYSYMBOL_RESERVAR = 5,                   /* RESERVAR  */
  YYSYMBOL_NUMERO = 6,                     /* NUMERO  */
  YYSYMBOL_CANCELAR = 7,                   /* CANCELAR  */
  YYSYMBOL_RESERVA = 8,                    /* RESERVA  */
  YYSYMBOL_VERIFICAR = 9,                  /* VERIFICAR  */
  YYSYMBOL_AJUDA = 10,                     /* AJUDA  */
  YYSYMBOL_LISTAR = 11,                    /* LISTAR  */
  YYSYMBOL_RESERVAS = 12,                  /* RESERVAS  */
  YYSYMBOL_DETALHES = 13,                  /* DETALHES  */
  YYSYMBOL_SAIR = 14,                      /* SAIR  */
  YYSYMBOL_NUM = 15,                       /* NUM  */
  YYSYMBOL_ID = 16,                        /* ID  */
  YYSYMBOL_17_n_ = 17,                     /* '\n'  */
  ...
  YYSYMBOL_pesquisar = 22,                 /* pesquisar  */
  YYSYMBOL_reservar = 23,                  /* reservar  */
  YYSYMBOL_cancelar = 24,                  /* cancelar  */
  YYSYMBOL_listar = 25,                    /* listar  */
  YYSYMBOL_ajuda = 26,                     /* ajuda  */
  YYSYMBOL_detalhes = 27,                  /* detalhes  */
  YYSYMBOL_sair = 28                       /* sair  */
};
...
static const yytype_int8 yyrline[] =
{
      ...
      76,    77,    78,    79,    82,    86,    90,    94,    98,   102,
     106
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PROCURAR", "VOOS",
  "RESERVAR", "NUMERO", "CANCELAR", "RESERVA", "VERIFICAR", "AJUDA",
  "LISTAR", "RESERVAS", "DETALHES", "SAIR", "NUM", "ID", "'\\n'",
  "$accept", "input", "line", "comando", "pesquisar", "reservar",
  "cancelar", "listar", "ajuda", "detalhes", "sair", YY_NULLPTR
};
...
{
     -16,     0,   -16,   -15,     2,    -2,     1,   -16,    -4,    -3,
     -16,   -16,   -16,    -1,   -16,   -16,   -16,   -16,   -16,   -16,
     -16,   -16,   -16,     3,     4,   -16,   -16,   -16,   -16,   -16
};
...
static const yytype_int8 yydefact[] =
{
      ...
      20,     4,     3,     0,     7,     8,     9,    12,    10,    11,
      13,     6,    14,     0,     0,    17,    19,     5,    15,    16
};
...
{
       2,     3,    21,     4,    23,     5,    22,     6,    25,    24,
       7,     8,    26,     9,    10,     0,    27,    11,    28,    29
};

static const yytype_int8 yycheck[] =
{
       0,     1,    17,     3,     6,     5,     4,     7,    12,     8,
      10,    11,    15,    13,    14,    -1,    17,    17,    15,    15
};
...
{
       0,    19,     0,     1,     3,     5,     7,    10,    11,    13,
      14,    17,    20,    21,    22,    23,    24,    25,    26,    27,
      28,    17,     4,     6,     8,    12,    15,    17,    15,    15
};
...
#line 1204 "bot.c"
  ...
  case 14: /* pesquisar: PROCURAR VOOS  */
#line 82 "yacc.y"
                         {
    listar_voos();
}
#line 1212 "bot.c"
  ...
  case 15: /* reservar: RESERVAR NUMERO NUM  */
#line 86 "yacc.y"
                              {
    reservar_voo((yyvsp[0].num));
}
#line 1220 "bot.c"
    break;

  case 16: /* cancelar: CANCELAR RESERVA NUM  */
#line 90 "yacc.y"
                               {
    cancelar_reserva((yyvsp[0].num));
}
#line 1228 "bot.c"
    break;

  case 17: /* listar: LISTAR RESERVAS  */
#line 94 "yacc.y"
                         {
    listar_reservas();
}
...
#line 1244 "bot.c"
  ...
  case 19: /* detalhes: DETALHES NUM  */
#line 102 "yacc.y"
                       {
    detalhe_reserva((yyvsp[0].num));
}
#line 1252 "bot.c"
    break;
